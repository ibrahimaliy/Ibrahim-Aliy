  ...
  if (isFlagship) {
    return (
      <article className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0c0c0e] p-5 sm:p-7 md:p-9 transition duration-200 hover:border-zinc-300 dark:hover:border-zinc-700 shadow-sm dark:shadow-none">
        ...
        {project.liveNote && (
          <div className="mb-5 sm:mb-6 rounded-lg border border-amber-500/25 bg-amber-500/10 dark:bg-amber-500/5 p-3 sm:p-3.5 flex items-start gap-2.5 text-xs text-amber-800 dark:text-amber-200/90 leading-relaxed">
